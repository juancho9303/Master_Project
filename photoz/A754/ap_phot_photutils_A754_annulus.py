...
bkg_sumg = bkg_meang * apertures.area()
bkg_sumr = bkg_meanr * apertures.area()
bkg_sumi = bkg_meani * apertures.area()
bkg_sumu = bkg_meanu * apertures.area()
...
phot_tableg.write('ap_phot_g_annulus.txt',format='ascii.ipac')
phot_tabler.write('ap_phot_r_annulus.txt',format='ascii.ipac')
phot_tablei.write('ap_phot_i_annulus.txt',format='ascii.ipac')
phot_tableu.write('ap_phot_u_annulus.txt',format='ascii.ipac') 
