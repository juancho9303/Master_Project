...
; Template & catalog fluxes
 openr,lun,'OUTPUT/photz.tempfilt',/swap_if_big_endian,/get_lun
 ...
 NRESTFILT = 0L & NTEMP_REST = 0L & readu,lun,NRESTFILT,NTEMP_REST
 lc_rest = dblarr(NRESTFILT)
 tempfilt_rest = dblarr(NRESTFILT,NTEMP_REST)
 readu,lun,lc_rest,tempfilt_rest
 close,/all
; 
; Coeffs (OBS_SED)
 openr,lun,'OUTPUT/photz_vdb_param.coeff',/get_lun,/swap_if_big_endian
 s = lonarr(4) & readu,lun,s
 NFILT=s[0] & NTEMP = s[1] & NZ = s[2] & NOBJ = s[3]
...
; Full templates (TEMP_SED)
 openr,lun,'OUTPUT/photz_vdb_param.temp_sed',/get_lun,/swap_if_big_endian
...
; 
; POFZ
 openr,lun,'OUTPUT/photz_vdb_param.pz',/get_lun,/swap_if_big_endian
...
; 
; Stored z values
 openr,lun,'OUTPUT/photz_vdb_param.zbin',/get_lun,/swap_if_big_endian
