...
; 
; Coeffs (OBS_SED)
 openr,lun,'OUTPUT/A990.coeff',/get_lun,/swap_if_big_endian
 s = lonarr(4) & readu,lun,s
 NFILT=s[0] & NTEMP = s[1] & NZ = s[2] & NOBJ = s[3]
...
; Full templates (TEMP_SED)
 openr,lun,'OUTPUT/A990.temp_sed',/get_lun,/swap_if_big_endian
...
; 
; POFZ
 openr,lun,'OUTPUT/A990.pz',/get_lun,/swap_if_big_endian
...
; 
; Stored z values
 openr,lun,'OUTPUT/A990.zbin',/get_lun,/swap_if_big_endian
