...
#Matrix_g = np.matrix([F_g, F_err_g, F_r, F_err_r, F_u, F_err_u, F_i, F_err_i])
Matrix_g = np.matrix([coordx_g, coordy_g, F_g, F_err_g])
Matrix_r = np.matrix([coordx_r, coordy_r, F_r, F_err_r])
Matrix_u = np.matrix([coordx_u, coordy_u, F_u, F_err_u])
Matrix_i = np.matrix([coordx_i, coordy_i, F_i, F_err_i])
