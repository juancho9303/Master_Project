...
plt.plot(np.log10(z), y, '.', c = 'darkorange', label = r"$\mathrm{Galaxies}$");
plt.plot(np.log10(z[filter1]), y[filter1], '.', c = 'black');
plt.plot(np.log10(z[filter5]), y[filter5], '.', c = 'black');
plt.plot(np.log10(z[filter4]), y[filter4], '.', c = 'black');
plt.plot(np.log10(z[filter2]), y[filter2], '.', c = 'black', label = r"$\mathrm{Stars}$");
