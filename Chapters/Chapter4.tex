...
The INT images were obtained using multiple exposures so it was necessary to make a mosaic of them using \texttt{SWARP}.

\section{Sextractor}

\citeyear{Reference27}
