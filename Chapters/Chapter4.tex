...
We use \texttt{IRAF} to make the color images using our g,r,U,i bands. Let's keep using ABELL754 which is a low redshift galaxy ($z=0.054$) cluster with a calculated mass of $\text{M}_{200}=9.8\times 10^{15} \text{M}_{\odot}$ (\textcolor{blue}{Sifon et. al.} \citeyear{Reference9})
...
citation of \texttt{EAZY} \textcolor{blue}{Brammer et. al.} (\citeyear{Reference22}) 
