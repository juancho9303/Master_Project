...
\begin{figure}[H]
\centering
\includegraphics[width=15cm]{images/magnitude_distribution_A2029.png}
\caption[Magnitude distribution of galaxies in Abell 2029]{Magnitude distribution for the galaxies whose photometric redshift is below 2 with their respective ID for cluster Abell 2029.}
\end{figure}