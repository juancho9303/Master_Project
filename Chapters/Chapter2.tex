...
CFHT can see objects as deep as m=23 but Hubble Space Telescope culd see objects as deep as m=25 so it should be able to see many objects that have been lensed.
...
the last figure is from the paper "A systematic variation of the stellar initial mass function in early-type galaxies" from Cappellari et. al. 2012
