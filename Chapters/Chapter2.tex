...
From Dutton and Maccio 2014 we get the following image for the concentration parameter: we see that the concentration parameter depends on the mass and the redshift as we see in the following plot:
